...
type Filter interface {
	...
	GetGroupingContext(tagKeyIDs []tag.KeyID, seriesIDs *roaring.Bitmap) (GroupingContext, error)
	// GetGroupingContext2 returns the context of group by
	//GetGroupingContext2(tagKeyIDs []tag.KeyID, tagValueIDs []*roaring.Bitmap) (GroupingContext, error)
}

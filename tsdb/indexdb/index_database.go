...
func (db *indexDatabase) GetGroupingContext(tagKeyIDs []tag.KeyID, seriesIDs *roaring.Bitmap) (series.GroupingContext, error) {
	return db.index.GetGroupingContext(tagKeyIDs, seriesIDs)
}

// GetGroupingContext returns the context of group by
func (db *indexDatabase) GetGroupingContext2(tagKeyIDs []tag.KeyID, seriesIDs *roaring.Bitmap) (series.GroupingContext, error) {
	return db.index.GetGroupingContext(tagKeyIDs, seriesIDs)
}
